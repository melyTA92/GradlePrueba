...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=latin1 COMMENT='Representa al ciclo en la cual los premios pertenecen';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT  IGNORE INTO `ciclo` (`ciclo_id`, `ciclo_nombre`, `ciclo_descripcion`, `ciclo_fecha_inicio`, `ciclo_fecha_fin`) VALUES (1,'Ciclo BarceFest','Ciclo BarceFest','2018-01-01','2018-02-01');
...
INSERT  IGNORE INTO `ciclo_evento` (`ciclo_evento_id`, `ciclo_id`, `evento_id`, `estado_id`, `total_premios`) VALUES (1,1,1,1,200);
...
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=latin1 COMMENT='Representa a los premios que estarán en un ciclo determinado';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1 COMMENT='Representa el evento a jugar';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT  IGNORE INTO `evento` (`evento_id`, `evento_nombre`, `evento_descripcion`, `evento_total_jugadas`, `estado_id`, `evento_url_imagen`) VALUES (1,'BarceFest','BarceFest',NULL,1,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1 COMMENT='Representa a los premios para que se regalen en un dia y hora especifico';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=latin1 COMMENT='Tabla que indica el registro de los participantes que ingresan a jugar';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=latin1 COMMENT='Representa a N numero de boletos de los participantes';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=latin1 COMMENT='Taba que indica los premios del evento';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT  IGNORE INTO `premio` (`premio_id`, `premio_nombre`, `premio_descripcion`, `premio_url_imagen`, `estado_id`, `categoria_id`) VALUES (1,'GORRA','Premio','premios/imagenes/premio_1.png',1,4),(2,'TOMATODO','Prueba','premios/imagenes/premio_2.png',1,5),(3,'PENDRIVE','Premio','premios/imagenes/premio_3.png',1,3),(4,'CELULAR','Premio','premios/imagenes/premio_4.png',1,1),(5,'MOTO','Premio','premios/imagenes/premio_5.png',1,1),(6,'CHOMPA','Premio','premios/imagenes/premio_6.png',1,3),(7,'MOTO HONDA','premio alto','premios/imagenes/premio_7.png',1,1),(8,'GORRA ADIDAS','premio bajo','premios/imagenes/premio_8.png',1,6),(9,'TOMATODO NIKE','Premio medio','premios/imagenes/premio_9.png',1,4),(10,'GORRA ADIDAS PRUEBA','Gorra Adidas Prueba','premios/imagenes/premio_10.png',1,6);
...
) ENGINE=InnoDB AUTO_INCREMENT=543 DEFAULT CHARSET=latin1 COMMENT='Tabla que indica los premios de los participantes que jugaron en el evento';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT  IGNORE INTO `probabilidades` (`probabilidad_id`, `probabilidad_porcentaje`, `estado_id`, `probabilidad_hora_inicio`, `probabilidad_hora_fin`) VALUES (11,100,1,NULL,NULL);
...
INSERT  IGNORE INTO `tipo_url` (`tipo_url_id`, `tipo_url_nombre`, `tipo_url_descripcion`) VALUES (1,'VIDEO_PRINCIPAL','VIDEO PROMOCIONAL'),(2,'BOTON_PRINCIPAL',NULL),(3,'FONDO_JUEGO',NULL),(4,'BOTON_JUEGO',NULL),(5,'SONIDO_JUEGO',NULL),(6,'BASE_JUEGO',NULL),(7,'PRIMERA_PUERTA',NULL),(8,'SEGUNDA_PUERTA',NULL),(9,'TERCERA_PUERTA',NULL);
...
-- Dump completed on 2018-08-27  9:40:06
